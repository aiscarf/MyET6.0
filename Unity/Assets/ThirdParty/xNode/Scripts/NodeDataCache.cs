...
namespace XNode
{
    ...
    {
        private static Dictionary<System.Type, List<NodePort>> portDataCache;
        ...
        {
            portDataCache = new Dictionary<Type, List<NodePort>>();
        ...
        public static List<FieldInfo> GetNodeFields(System.Type nodeType)
        {
            ...
            while ((tempType = tempType.BaseType) != null && tempType != typeof(XNode.Node))
            {
        ...
        private static void CachePorts(System.Type nodeType)
        {
            ...
            for (int i = 0; i < fieldInfo.Count; i++)
            {
                ...
                {
                    NodeDebug.LogError("Field " + fieldInfo[i].Name + " of type " + nodeType.FullName +
        ...
        //
        // [System.Serializable]
        // private class PortDataCache : Dictionary<System.Type, List<NodePort>>, UnityEngine.ISerializationCallbackReceiver
        // {
        //     [UnityEngine.SerializeField] private List<System.Type> keys = new List<System.Type>();
        //     [UnityEngine.SerializeField] private List<List<NodePort>> values = new List<List<NodePort>>();
        //
