...
namespace XNode
{
    ...
    public class Node
    {
        ...
        public void SyncData(Node data)
        {
            this.NodeId = data.NodeId;
            this.TypeQualifiedName = data.TypeQualifiedName;
            this.ports = data.ports;

            foreach (var kv in ports)
            {
                kv.Value.node = this;
                kv.Value.InitConnection();
            }
        }
            ...
            Node.TypeConstraint typeConstraint = TypeConstraint.None, string fieldName = null)
        {
            ...
            {
                NodeDebug.LogWarning("Port '" + fieldName + "' already exists in " + NodeId);
        ...
        public T GetInputValue<T>(string fieldName, T fallback = default(T))
        {
            ...
            if (port.IsConnected) return port.GetInputValue<T>();
            return (T)port.DefaultValue.ForceConvert(port.ValueType);
        }
        ...
        {
            // NodeDebug.LogWarning("No GetValue(NodePort port) override defined for " + GetType());
            return null;
        }
        ...
        public class NodeTintAttribute : Attribute
        {
            ...
            {
                color = new UnityEngine.Color32(r, g, b, byte.MaxValue);
            }
        }
        ...
        #region ControlInput/ControlOutput
        ...
        [Serializable]
        public class NodePortDictionary : Dictionary<string, NodePort>, UnityEngine.ISerializationCallbackReceiver
        {
            [UnityEngine.SerializeField]
            public List<string> keys = new List<string>();

            [UnityEngine.SerializeField]
            public List<NodePort> values = new List<NodePort>();
