...
//             {
//                 NodeProxy nodeAsset = AssetDatabase.LoadMainAssetAtPath(movedAssets[i]) as NodeProxy;
//
...
//                 {
//                     AssetDatabase.SetMainObject(nodeAsset.graphProxy, movedAssets[i]);
//                     AssetDatabase.ImportAsset(movedAssets[i]);
//
//                     nodeAsset.name = NodeEditorUtilities.NodeDefaultName(nodeAsset.GetNodeType());
