...
namespace ET
{
    public class Event_EnterMobaBegin : AEvent<EventType.EnterMobaBegin>
    {
        ...
        protected override async ETTask Run(EventType.EnterMobaBegin args)
        {
            ...
            // 打开加载场景的进度界面.
            await UIManager.Instance.CreateUI(UIType.UIBattleLoading);
            await UIManager.Instance.OpenUI(UIType.UIBattleLoading, null);
            
            // TODO 如何解耦合, 推送更新进度消息.
            UIManager.Instance.GetUI(UIType.UIBattleLoading).GetComponent<UIBattleLoadingComponent>().m_sliderProgress.value = 0f;
            // 加载场景资源
            ...
            // TODO 假的模拟进度条.
            UIManager.Instance.GetUI(UIType.UIBattleLoading).GetComponent<UIBattleLoadingComponent>().m_sliderProgress.value = 0.5f;
            await TimerComponent.Instance.WaitAsync(2000);
            UIManager.Instance.GetUI(UIType.UIBattleLoading).GetComponent<UIBattleLoadingComponent>().m_sliderProgress.value = 1f;
