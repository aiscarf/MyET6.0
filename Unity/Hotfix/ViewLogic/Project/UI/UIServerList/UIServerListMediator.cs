...
namespace ET
{
    public class UIServerListMediator : UIMediator<UIServerListComponent>
    {
        ...
        LoopListViewItem2 OnGetItemByIndex(LoopListView2 listView, int index)
        {
            ...
            var btn = item.transform.Find("EUI_Button_Bg").GetComponent<Button>();
            var txtName = item.transform.Find("EUI_Text_Name").GetComponent<Text>();
            var txtTime = item.transform.Find("EUI_Text_Time").GetComponent<Text>();
