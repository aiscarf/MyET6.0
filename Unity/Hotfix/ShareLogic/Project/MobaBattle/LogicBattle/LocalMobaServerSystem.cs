...
namespace ET
{
    public class LocalMobaServerComponentAwakeSystem : AwakeSystem<LocalMobaServerComponent>
    {
        public override void Awake(LocalMobaServerComponent self)
        {
            ...
            self.m_fLogicFrameDelta = self.GetFrameSyncComponent().LOGIC_FRAME_DELTA / 1000f;
        }
    }
    ...
    public class LocalMobaServerComponentUpdateSystem : UpdateSystem<LocalMobaServerComponent>
    {
        ...
        {
            for (self.m_fAccumilatedTime += Time.deltaTime;
    ...
    public static class LocalMobaServerSystem
    {
        public static void ReceiveOperation(this LocalMobaServerComponent self, int uid, C2B_FrameMsg frameMsg)
        {
            ...
            else
            {
                ...
                TimerComponent.Instance.NewOnceTimer(TimeHelper.ServerNow() + 5000, TimerType.LocalDownlinkDelayTimer,
                    action);
            }
        }
        ...
        public static void SendCurNetFrameData(this LocalMobaServerComponent self)
        {
            ...
            Action action = () => { self.GetFrameSyncComponent().AddLogicFrame(frameData); };
        ...
        // public static void RegisterHeartBeatCallback(this LocalMobaServerComponent self, Action action)
        // {
        //     
        // }
        //
        // // TODO 客户端发给服务器, 服务器立马回应一个结果.
